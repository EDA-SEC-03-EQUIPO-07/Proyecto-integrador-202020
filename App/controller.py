...
def primer_requerimiento(analyzer, number_companies):
    return model.segunda_consulta(analyzer, number_companies)


def tercera_consulta(analyzer, number_taxis, date):
    return model.tercera_consulta(analyzer, number_taxis, date)
